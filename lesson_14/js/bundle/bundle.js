...
},{"./src/ajax.js":278,"./src/calc.js":279,"./src/modal.js":280,"./src/scroll.js":281,"./src/slider.js":282,"./src/tab.js":283,"./src/timer.js":284,"@babel/polyfill":1}],278:[function(require,module,exports){
'use strict';
...
function scrollPage() {
    ...
    function scrollingAll(draw, brPosition, trPosition, duration) {
        ...
        var scroll = requestAnimationFrame(function scrollingAll() {
    ...
    function scrollingEdge(draw, duration) {
        ...
        var scroll = requestAnimationFrame(function scrollingEdge() {
            var timePassed = Date.now() - start;
        ...
        if (target.tagName == 'A') {
            ...
            if (browser.search(/Edge/) > 0) {
                scrollingEdge(function (timePassed) {
                    var trg = document.getElementById(tr);
                    window.scrollBy(0, trg.getBoundingClientRect().top / 20 - 3);
                }, 1200);
            } else {
                var targ = document.getElementById(tr).getBoundingClientRect().top - navMenu.clientHeight,
